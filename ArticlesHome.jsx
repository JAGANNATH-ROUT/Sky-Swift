      ...
      <section className="max-w-7xl mx-auto flex items-center gap-10 px-6 pb-16 flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2">
          <p className="text-gray-600 leading-relaxed">
           For the first-time private jet flyers, getting started might feel daunting.
            But it opens the world to you: Chicago to L.A. and back by tee time? Omaha to Aruba for the weekend? 
            When contacting a jet provider, you’ll be asked to provide specific details and your travel needs. 
            These questions are near-universal in the private […]
          </p>
        </div>
