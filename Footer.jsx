import visaLogo from "../assets/img3.png";
import masterCardLogo from "../assets/img4.png";
import mpesaLogo from "../assets/img5.png";
      ...
      <div className="flex flex-col gap-5 px-6 py-10 md:flex-row justify-evenly">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <span className="text-sm text-blue-200">
              Booking: +9-9692142622 <br />
              Inquiries: +91-9692142622
            </span>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <a
              href="mailto:info@sky-swift.com"
